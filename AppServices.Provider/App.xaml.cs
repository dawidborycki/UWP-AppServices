...
namespace AppServices.Provider
{
    ...
    {        
            ...
            AppServiceConnection sender, AppServiceRequestReceivedEventArgs args)
        {
            ...
            var statusCode = MessageHelper.ParseRequestMessage(args.Request.Message);

            // Set color accordingly and send response
            var colorToSend = statusCode == StatusCode.OK ? CurrentColor : Colors.White;
            await MessageHelper.SendResponse(args.Request, colorToSend, statusCode);
